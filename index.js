...
let chosenDay = new Date("2022-10-30");
...
function displayDate(timeDiff, seconds, minutes, hours, days) {
   if (timeDiff > 0) {
      if (seconds < 10) {
         ...
         document.querySelector(".seconds .one").textContent =
            seconds.toString()[0];
      } else {
         document.querySelector(".seconds .ten").textContent =
            seconds.toString()[0];
         document.querySelector(".seconds .one").textContent =
            seconds.toString()[1];
      }
      ...
      if (minutes < 10) {
         ...
         document.querySelector(".minutes .one").textContent =
            minutes.toString()[0];
      } else {
         document.querySelector(".minutes .ten").textContent =
            minutes.toString()[0];
         document.querySelector(".minutes .one").textContent =
            minutes.toString()[1];
      }
      ...
      if (hours < 10) {
         ...
         document.querySelector(".hours .one").textContent =
            hours.toString()[0];
      } else {
         document.querySelector(".hours .ten").textContent =
            hours.toString()[0];
         document.querySelector(".hours .one").textContent =
            hours.toString()[1];
      }
